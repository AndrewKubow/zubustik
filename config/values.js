...
const values = {
  ...
  // The host on which to send request (API).
  ...
  api: EnvVars.string('API', 'https://api.idanylov.co.ua'),
  ...
  htmlPage: {
    titleTemplate: 'ZUBUSTIK - %s',
    defaultTitle: 'ZUBUSTIK - Счастливый билет на автобус',
    description: 'Счастливый билет на автобус',
  },
  ...
  cspExtensions: {
    ...
    imgSrc: ['maps.googleapis.com', 'csi.gstatic.com', 'maps.gstatic.com'],
    mediaSrc: [],
    manifestSrc: [],
    objectSrc: [],
    scriptSrc: [
